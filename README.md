...
It is my understanding that functional code is easier to write, runs faster, and uses less memory than object oriented programming, but is less readable compared to object oriented programming.
